 ...
 */
public class Animation extends Genre {
    ...
    public List<String> getMovieList (){
        List<String> animationMovies = new ArrayList<String>();
        animationMovies.add("Spectre");
        animationMovies.add("Mechanic");
        animationMovies.add("JohnWick");
